...
const SmallThingsSection: React.FC = () => {
  ...
  const smallThings = [
    ...
    },
    {
      id: 3,
      title: "чтение",
      image: "https://images.unsplash.com/photo-1506880018603-83d5b814b5a6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1347&q=80",
      description: "погружение в другие миры и истории, когда каждая страница открывает новые горизонты мысли и воображения, позволяя на время забыть о повседневных заботах",
    },
    {
      id: 4,
      title: "прогулка в тишине",
      image: "https://images.unsplash.com/photo-1476820865390-c52aeebb9891?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      description: "моменты наедине с собой и окружающим миром, когда шаг за шагом обретаешь внутреннее равновесие и ясность мысли, освобождаясь от шума повседневности",
    },
    {
      id: 5,
      ...
      description: "возвращение к истокам, где шелест листьев и пение птиц напоминают о простых радостях бытия, а каждый вдох наполняет тело и разум новой энергией",
    },
    {
      id: 6,
      ...
      description: "особое чувство комфорта и обновления, когда прикосновение хрустящей ткани к коже становится маленьким праздником чистоты и уюта в конце дня",
    },
    {
      id: 7,
      title: "уютные носки",
      image: "https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      description: "теплые объятия для ног, создающие ощущение защищенности и домашнего тепла, особенно в прохладные вечера, когда за окном бушует непогода",
    },
    {
      id: 8,
      title: "любимая чашка",
      image: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      description: "верный спутник утренних размышлений и вечерних чаепитий, в форме и текстуре которого скрыты истории и воспоминания, делающие каждый глоток особенным",
    },
    {
      id: 9,
      ...
      description: "молчаливые хранители мыслей и чувств, где каждая строчка становится отпечатком момента жизни, а процесс письма превращается в медитативный ритуал самопознания",
    },
    {
      id: 10,
      ...
      description: "редкие и ценные моменты искренности и открытости, когда слова текут свободно, создавая невидимые мосты между людьми и оставляя после себя чувство глубокой связи",
    },
    {
      id: 11,
      title: "йога",
      image: "https://images.unsplash.com/photo-1545389336-cf090694435e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      description: "путешествие внутрь себя через осознанное движение и дыхание, когда тело и разум находят гармонию в простых и сложных асанах, а время словно останавливается",
    },
  ];
