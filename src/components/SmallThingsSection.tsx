...
const SmallThingsSection: React.FC = () => {
  ...
  const smallThings = [
    {
      ...
      image:
        "https://cdn.poehali.dev/files/cd648294-1b95-40ad-9289-bbd46d85ff2e.png",
      description:
        "теплый напиток, полный тепла и уютной атмосферы осеннего дня с нотками корицы, мускатного ореха и имбиря",
    },
    {
      id: 2,
  ...
  // Дополнительные маленькие вещи без изображений
  ...
  return (
    <section className="py-16 px-6 bg-black" data-animate>
      <div className="max-w-5xl mx-auto">
        ...
        {/* Дополнительные вещи отображаются в виде элегантной сетки */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-6 gap-y-8 animate-fadeIn">
          {additionalThings.map((thing, index) => (
            ...
            >
              ...
              <p className="text-gray-300 font-light group-hover/item:text-gold transition-colors duration-300">
                {thing}
              </p>
            </div>
          ))}
