    ...
    <section className="relative w-full bg-black py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="relative p-4">
          ...
          <div className="absolute top-12 left-0 w-full p-4">
            <p className="quote-italic text-xl md:text-2xl mb-6 max-w-md">
              "когда ты молод, нужно побольше оставаться наедине с собой и своей болью„
            </p>
          </div>
          
          <div className="absolute bottom-12 right-0 w-full p-4 text-right">
            <p className="quote-italic text-xl md:text-2xl max-w-md ml-auto">
      ...
      <div className="mt-16 mx-auto max-w-4xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative bg-charcoal p-8 min-h-[400px] animate-slideUp">
            <img 
            ...
            <div className="relative z-10">
              <h3 className="text-sm text-gray-400 uppercase mb-6 tracking-wider">
                практики внутреннего внимания
              </h3>
              
              <ul className="space-y-4 text-sm text-gray-300">
                <li className="pb-2 border-b border-gray-800">написание утренних страниц</li>
                <li className="pb-2 border-b border-gray-800">общение с людьми из разных сфер</li>
                <li className="pb-2 border-b border-gray-800">обращение к роду — разговоры с бабушкой</li>
                <li className="pb-2 border-b border-gray-800">посещение храмов и церквей одной</li>
                <li className="pb-2 border-b border-gray-800">чайные церемонии в одиночестве</li>
                <li className="pb-2 border-b border-gray-800">просмотр кино и описание впечатлений после</li>
                <li className="pb-2 border-b border-gray-800">создание дизайн-работ для себя</li>
                <li className="pb-2 border-b border-gray-800">проба различных несвойственных мне хобби</li>
              </ul>
            </div>
          </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="text-center max-w-xs">
                <p className="quote-italic text-2xl mb-3">
                  что мне<br />помогает<br />лучше себя<br />понять
                </p>
